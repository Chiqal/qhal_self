...
print "LOGIN SUCCES QHAL"
reload(sys)
sys.setdefaultencoding('utf-8')

helpMessage ="""✯  Selfbot v2.1  ✯
...
admin=["u22ed21bd97a4291726fa53b756ce2f01","ufafdbacbff38226d151940789db301d7","u1419826892f933d1280d8f59a485a929","u2c723b29dd222fe3f6bf70304c476230","u98a5ab007afdcc8ba74a33b778bc65f4","ufd446574ba860923aeb438c933c836ce"]
...
#--------------------------------------------------------
                ...
                try:
                    ...
                    cl.comment(url['result']['posts'][0]['userInfo']['mid'], url['result']['posts'][0]['postInfo']['postId'], "Auto Like By: A ChiqaLFV")
